...
const packageOrder = [
  ...
  { name: "@anlyx/adapter-openapi", packageDir: "packages/adapter-openapi" },
  { name: "@anlyx/adapter-manual", packageDir: "packages/adapter-manual" },
  { name: "@anlyx/adapter-next", packageDir: "packages/adapter-next" },
  { name: "@anlyx/adapter-spring", packageDir: "packages/adapter-spring" },
  { name: "@anlyx/capture", packageDir: "packages/capture" },
