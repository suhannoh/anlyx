...
This document fixes the visual token direction for the local Project JSON viewer.
...
Optional dark surfaces are not part of the Phase 1 viewer contract. The main
product UI MUST be readable in Clean Light first.
